<template>
  <div>
    <div class="Css3">
      <video src="http://localhost:8000/movie/test0.mp4" controls="controls" autoplay="autoplay" loop=true width="200px" height="320px" > 视频的讲解 </video>
    </div>
    <div>
   ...
   <div style="margin: 20px;"></div>
    ...
    <el-form-item label="密码" prop="pass">
      <el-input id="input-test" type="text" v-model="ruleForm2.pass" auto-complete="off"></el-input>
    </el-form-item>
